...
// WhatsApp pairing/logout are entirely out of scope here and live
// exclusively in src/app/admin/whatsapp — this panel only ever reads and
// sends messages on conversations already assigned or claimable by the
// signed-in agent. The connection badge below is read-only, no control.
