...
//
// Extracted verbatim from the former standalone /admin/dinstar page
// (merged into /admin/dinstar's Gateway tab, now sharing the route with
// the Extensions tab — see that page). No behavior change from the
// original.
