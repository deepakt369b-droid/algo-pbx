...
- [ ] **Multi-tenant SaaS foundation — WAVE 2a (2026-09-04, see Build Log)** — the scoping MECHANISM, infrastructure only. Plan: `~/.claude/plans/task-multi-tenant-saas-foundation-purring-parnas.md` §2.
